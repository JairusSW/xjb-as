// Allocation-path latency for exact integers. Each operation formats all eight
// values in a bucket; divide ns/op by eight for per-conversion latency.

import { bench, dumpToFile, blackbox } from "../assembly/__benches__/lib/bench";
import { dtoa } from "../assembly/dtoa";
import { ftoa } from "../assembly/ftoa";
